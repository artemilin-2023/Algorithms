...
- [Алгоритмы и структуры данных ](#алгоритмы-и-структуры-данных-)
  ...
  - [Алгоритмы обработки данных](#алгоритмы-обработки-данных)
    ...
    - [Сортировка](#сортировка)
      ...
      - [Параллельная сортировка слиянием](#параллельная-сортировка-слиянием)
  - [Структуры данных](#структуры-данных)
    - [Список](#список)
    - [Очередь](#очередь)
    - [Хеш-таблица](#хеш-таблица)
    - [Бинароне дерево поиска](#бинароне-дерево-поиска)
    - [Красно-чёрное дерево поиска](#красно-чёрное-дерево-поиска)
...
Реализация [тут](https://github.com/artemilin-2023/Algorithms/blob/ec1571540d44afa97dc19c25c668f472666b1989/Algorithms/Sorting.cs#L148)
...
Реализация [тут](https://github.com/artemilin-2023/Algorithms/blob/c9fe72eacb78fe2834ab48e5072822abd449650e/Algorithms/Sorting.cs#L73)
...
![parallel merge sort](./readme-source/parallel-merge-sort.png)
